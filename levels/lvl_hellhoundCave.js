var hellhoundCave = {
	...
	description: "Placeholder!",
 	...
 	events: {
 		...
 		puppy: function() {
 			view.displayDialogue("Growl?  >snurfle<  Woof.","Terrifying Hellhound... Whelp",mobs[2].img,"right");
 			this.location.event = undefined;
 			for (i in mobs) {
 				if (mobs[i] === this) {
 					mobIndex = i;
 		...
 		puppyJoin: function() {
 			view.displayDialogue("Hellpuppy has joined the party!",undefined,mobs[2].img,"left");
 		...
 		home2: function() {
 			view.displayDialogue("The road back to Pileus is not long, but takes the remainder of the day.  By the time you reach the city that you call home, the sun is pregnant on the horizon and supper is at the forefront of your mind.  But the everyday sounds and bustle of the city at dinnertime is not what you encounter.  Instead, the city is alight with torches and full of shouting, cheering, shouting.  Something is happening… something big.","Narrator","img/narrator.jpg","right")
			view.nextEvent('wall');
 		},
 		
 		wall: function() {
 			view.displayDialogue("What the what, now?  Hey, Doti's at the gatehouse.  She probably knows what's happening.<br />HEY DOTI WHAT'S HAPPENING?",mobs[1].name,mobs[1].img,"left");
 			view.nextEvent('wall2');
 		},
 		
 		wall2: function() {
 			view.displayDialogue("The City Council has denounced the Ogre King and declared us independent!  It's madness inside.  Everyone fears the King will come crush us overnight, like some all-powerful god.  Pfft.  Civilians.","Doti","img/orc.png","right");
 			view.nextEvent('wall3');
 		},
 		
 		wall3: function() {
 			view.displayDialogue("But the King is going to come crush us, right?",mobs[1].name,mobs[1].img,"left");
 			view.nextEvent('wall4');
 		},
 		
 		wall4: function() {
 			view.displayDialogue("He can try.  Since the war, his armies are crippled and scattered.  We have enough time to prepare.  We won't go down without a fight.<br />In fact, the Council is chartering companies of soldiers now.","Doti","img/orc.png","right");
 			view.nextEvent('wall5');
 		},
 		
 		wall5: function() {
 			view.displayDialogue("Oh my gods!  Do you know what this means?",mobs[0].name,mobs[0].img,"left");
 			view.nextEvent('wall6');
 		},
 		
 		wall6: function() {
 			view.displayDialogue("That the city will be sacked, pillaged, and destroyed before I ever complete my training?",mobs[1].name,mobs[1].img,"right");
 			view.nextEvent('wall7');
 		},
 		
 		wall7: function() {
 			view.displayDialogue("No!  I can finally realize my lifelong dream… of becoming a badass hero!  We can get one of those charters.  You and me.  We can form a company of fighters, we can defend the city, we can finally be somebody.  We'll be <em>awesome</em>.",mobs[0].name,mobs[0].img,"left");
 			view.setupReturn();
 		},
 	},
